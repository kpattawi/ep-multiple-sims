...
# constants for this optimization
...
# adaptive_heating_setpoints = df
# adaptive_cooling_setpoints = df
# for i in range(0,len(df)):
# 	if df[i] <= 10:
# 		adaptive_cooling_setpoints[i] = 22.9
# 		adaptive_heating_setpoints[i] = 18.9
# 	elif df[i] >= 33.5:
# 		adaptive_cooling_setpoints[i] = 30.2
# 		adaptive_heating_setpoints[i] = 26.2
# 	else:
# 		adaptive_cooling_setpoints[i] = 30.2
# 		adaptive_heating_setpoints[i] = 26.2
...
heatSet = adaptive_heating_setpoints[(block-1)*12:(block-1)*12+n,0]
coolSet = adaptive_cooling_setpoints[(block-1)*12:(block-1)*12+n,0]
