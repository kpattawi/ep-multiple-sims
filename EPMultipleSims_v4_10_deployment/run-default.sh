...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/Socket6-${timestamp}.log -T "Socket6" -geometry 140x40+300+330 -e "mvn exec:java -P ExecJava,Socket6" &
waitUntilJoined Socket6 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/Socket7-${timestamp}.log -T "Socket7" -geometry 140x40+330+360 -e "mvn exec:java -P ExecJava,Socket7" &
waitUntilJoined Socket7 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/Socket8-${timestamp}.log -T "Socket8" -geometry 140x40+360+390 -e "mvn exec:java -P ExecJava,Socket8" &
waitUntilJoined Socket8 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/Socket9-${timestamp}.log -T "Socket9" -geometry 140x40+390+420 -e "mvn exec:java -P ExecJava,Socket9" &
