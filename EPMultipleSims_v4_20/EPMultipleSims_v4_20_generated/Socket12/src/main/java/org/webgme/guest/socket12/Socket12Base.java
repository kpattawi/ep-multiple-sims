package org.webgme.guest.socket12;

import org.webgme.guest.socket12.rti.*;
...
public class Socket12Base extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public Socket12Base(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
