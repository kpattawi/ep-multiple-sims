...
// Define the Socket12 type of federate for the federation.

public class Socket12 extends Socket12Base {
    ...
    public Socket12(FederateConfig params) throws Exception {
        super(params);
    }
