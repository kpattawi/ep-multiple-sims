...
// Define the Socket11 type of federate for the federation.

public class Socket11 extends Socket11Base {
    ...
    public Socket11(FederateConfig params) throws Exception {
        super(params);
    }
