package org.webgme.guest.socket11;

import org.webgme.guest.socket11.rti.*;
...
public class Socket11Base extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public Socket11Base(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
