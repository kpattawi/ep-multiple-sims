package org.webgme.guest.socket9;

import org.webgme.guest.socket9.rti.*;
...
// Define the Socket9 type of federate for the federation.

public class Socket9 extends Socket9Base {
    ...
    public Socket9(FederateConfig params) throws Exception {
        super(params);
    }
    ...
    private void execute() throws Exception {
        ...
        File file= new File("/home/vagrant/Desktop/ep_multiple_sims/EPMultipleSims_v4_2/EPMultipleSims_v4_2_generated/config.txt");
        ...
        ServerSocket welcomeSocket = new ServerSocket(6798, 50, addr);  // Can also be changed in config.txt
