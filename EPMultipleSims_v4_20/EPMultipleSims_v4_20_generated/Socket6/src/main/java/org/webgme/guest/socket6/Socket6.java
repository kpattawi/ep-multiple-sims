package org.webgme.guest.socket6;

import org.webgme.guest.socket6.rti.*;
...
// Define the Socket6 type of federate for the federation.

public class Socket6 extends Socket6Base {
    ...
    public Socket6(FederateConfig params) throws Exception {
        super(params);
    }
    ...
    private void execute() throws Exception {
        ...
        ServerSocket welcomeSocket = new ServerSocket(6795, 50, addr);  // Can also be changed in config.txt
