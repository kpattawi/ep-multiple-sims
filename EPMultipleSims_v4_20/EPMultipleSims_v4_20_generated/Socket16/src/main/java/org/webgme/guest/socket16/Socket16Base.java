package org.webgme.guest.socket16;

import org.webgme.guest.socket16.rti.*;
...
public class Socket16Base extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public Socket16Base(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
