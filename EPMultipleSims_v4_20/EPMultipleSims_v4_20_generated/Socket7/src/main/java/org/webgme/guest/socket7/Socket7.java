package org.webgme.guest.socket7;

import org.webgme.guest.socket7.rti.*;
...
// Define the Socket7 type of federate for the federation.

public class Socket7 extends Socket7Base {
    ...
    public Socket7(FederateConfig params) throws Exception {
        super(params);
    }
    ...
    private void execute() throws Exception {
        ...
        ServerSocket welcomeSocket = new ServerSocket(6796, 50, addr);  // Can also be changed in config.txt
