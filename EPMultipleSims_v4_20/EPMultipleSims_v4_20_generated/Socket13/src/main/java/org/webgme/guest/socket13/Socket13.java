...
// Define the Socket13 type of federate for the federation.

public class Socket13 extends Socket13Base {
    ...
    public Socket13(FederateConfig params) throws Exception {
        super(params);
    }
