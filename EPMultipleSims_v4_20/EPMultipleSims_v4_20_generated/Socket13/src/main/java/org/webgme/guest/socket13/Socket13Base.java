package org.webgme.guest.socket13;

import org.webgme.guest.socket13.rti.*;
...
public class Socket13Base extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public Socket13Base(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
