package org.webgme.guest.socket17;

import org.webgme.guest.socket17.rti.*;
...
public class Socket17Base extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public Socket17Base(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        // interaction pubsub
        Socket_Controller.publish(getLRC());
        Controller_Socket.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           Controller_Socket.get_handle(),
    ...
    public Socket_Controller create_Socket_Controller() {
        Socket_Controller interaction = new Socket_Controller();
