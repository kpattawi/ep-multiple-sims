...
// Define the Socket15 type of federate for the federation.

public class Socket15 extends Socket15Base {
    ...
    public Socket15(FederateConfig params) throws Exception {
        super(params);
    }
