package org.webgme.guest.socket15;

import org.webgme.guest.socket15.rti.*;
...
public class Socket15Base extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public Socket15Base(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
