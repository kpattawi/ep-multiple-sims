package org.webgme.guest.socket8;

import org.webgme.guest.socket8.rti.*;
...
// Define the Socket8 type of federate for the federation.

public class Socket8 extends Socket8Base {
    ...
    public Socket8(FederateConfig params) throws Exception {
        super(params);
    }
    ...
    private void execute() throws Exception {
        ...
        ServerSocket welcomeSocket = new ServerSocket(6797, 50, addr);  // Can also be changed in config.txt
