...
// Define the Socket10 type of federate for the federation.

public class Socket10 extends Socket10Base {
    ...
    public Socket10(FederateConfig params) throws Exception {
        super(params);
    }
