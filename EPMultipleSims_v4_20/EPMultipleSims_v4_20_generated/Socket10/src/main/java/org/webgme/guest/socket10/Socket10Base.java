package org.webgme.guest.socket10;

import org.webgme.guest.socket10.rti.*;
...
public class Socket10Base extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public Socket10Base(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
