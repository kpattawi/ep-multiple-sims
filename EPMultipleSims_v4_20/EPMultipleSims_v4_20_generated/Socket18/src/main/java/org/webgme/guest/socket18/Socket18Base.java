package org.webgme.guest.socket18;

import org.webgme.guest.socket18.rti.*;
...
public class Socket18Base extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public Socket18Base(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
