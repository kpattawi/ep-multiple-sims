...
// Define the Socket18 type of federate for the federation.

public class Socket18 extends Socket18Base {
    ...
    public Socket18(FederateConfig params) throws Exception {
        super(params);
    }
