package org.webgme.guest.socket19;

import org.webgme.guest.socket19.rti.*;
...
public class Socket19Base extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public Socket19Base(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
