...
// Define the Socket19 type of federate for the federation.

public class Socket19 extends Socket19Base {
    ...
    public Socket19(FederateConfig params) throws Exception {
        super(params);
    }
