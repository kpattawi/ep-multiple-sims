...
public class MarketBase extends SynchronizedFederate {
    ...
    public MarketBase(FederateConfig config) throws Exception {
        ...
        // interaction pubsub
        Market_Controller.publish(getLRC());
        Controller_Market.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           Controller_Market.get_handle(),
    ...
    public Market_Controller create_Market_Controller() {
        Market_Controller interaction = new Market_Controller();
